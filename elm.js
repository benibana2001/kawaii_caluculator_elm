...
var $author$project$Main$init = {
	buttons: {
		clear: 'clear',
		del: 'del',
		nums: $elm$core$List$reverse(
			A2($elm$core$List$range, 0, 9)),
		signs: _List_fromArray(
			['+', '-', '*', '/', '='])
	},
		...
		switch (msg.$) {
			case 'Input':
				...
				return _Utils_update(
					model,
					{
						current: $author$project$Main$stringToFloat(
							_Utils_ap(
								$elm$core$String$fromFloat(model.current),
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick(
						$author$project$Main$Input(_int))
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('comment-inner')
									]),
								_List_fromArray(
									[
										A2(
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$src('src/assets/character.png')
											]),
										_List_Nil)
									]))
							]))
